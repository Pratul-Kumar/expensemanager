...
export async function POST(request: Request) {
  try {
    ...
    const fromEmail = process.env.RESEND_FROM_EMAIL || 'Notely <onboarding@resend.dev>';
    ...
    const htmlContent = `
      <div style="font-family: sans-serif; max-width: 500px; margin: 0 auto; border: 1px solid #eaeaea; border-radius: 8px; overflow: hidden;">
        <div style="background-color: #f9fafb; padding: 30px; text-align: center; border-bottom: 1px solid #eaeaea;">
          <h1 style="margin: 0; color: #111827; font-size: 24px; letter-spacing: -0.5px;">NOTELY</h1>
          <p style="margin: 8px 0 0; color: #6b7280; font-size: 14px;">Your space. Your life.</p>
        </div>
        ...
        <div style="padding: 30px;">
          ...
          <p style="margin: 0 0 16px; color: #374151; font-size: 15px; line-height: 1.5;">
            Thanks for signing in to Notely.
          </p>
          
          <p style="margin: 0 0 24px; color: #374151; font-size: 15px; line-height: 1.5;">
            Notely helps you keep your notes, expenses and reminders organized in one simple place.
          </p>
          
          <div style="text-align: center; margin: 30px 0;">
            <a href="https://notely-app.com" style="background-color: #6366f1; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 500; font-size: 15px; display: inline-block;">
              Open Notely
            </a>
          </div>
